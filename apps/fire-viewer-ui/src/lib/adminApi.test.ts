...
describe('client API d’administration', () => {
  ...
  it('charge le poste de veille et la carte nationale depuis les contrats admin v2', async () => {
    ...
    const mapSignal = { observation_id: 'OBS-MAP-001', source_key: 'firms-feed', source_type: 'sensor', longitude: 6.2, latitude: 43.3, horizontal_uncertainty_m: 350, territory_code: '83', canonical_name_hint: 'Signal Maures', observed_at: '2026-07-15T09:57:00Z', received_at: '2026-07-15T09:58:00Z', verification_state: 'PENDING_REVIEW', match_decision: 'review', state: 'pending', proposed_fire_id: null, attached_fire_id: null };
