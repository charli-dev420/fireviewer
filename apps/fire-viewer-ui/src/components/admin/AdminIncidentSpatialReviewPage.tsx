...
export function AdminIncidentSpatialReviewPage({ fireId }: { readonly fireId: string }) {
  ...
  return <section aria-labelledby="admin-spatial-review-title">
    <AdminPageHeader title="Carte 3D et périmètre de l’incendie"><p>Le fond 3D reste inchangé. Dessinez ou corrigez le périmètre comme un calque superposé, puis validez-le avant publication.</p></AdminPageHeader>
